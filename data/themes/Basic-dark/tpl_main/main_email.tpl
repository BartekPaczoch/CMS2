...
<html>
	<head>
		...
		<style type="text/css">
			@import url("{{$TEMPLATE_HOME}}{{config::get(template)}}/bootstrap/css/bootstrap.min.css");
		...
		<script type="text/javascript" src="{{$TEMPLATE_HOME}}{{config::get(template)}}/bootstrap/js/bootstrap.min.js"></script>  
